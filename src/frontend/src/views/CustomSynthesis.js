...
export default class CustomSynthesis extends React.Component {
  state = {
    ...
    triggerDelete: false,
    strategy_anotherExpanded: false,
    strategy_randomExpanded: false,
  ...
  changeIsOpen = ({ e }) => {
    ...
    if (e.id.length !== undefined) {
      ...
      if (e.label === "strategy_another") {
        this.setState({
          strategy_anotherExpanded: !this.state.strategy_anotherExpanded,
        });
      } else if (e.label === "strategy_random") {
        this.setState({
          strategy_randomExpanded: !this.state.strategy_randomExpanded,
        });
      }
    }
    this.setState({});
  ...
  setTree = (tree) => {
    ...
    for (let i = 0; i < keys.length; i++) {
      ...
      if (keys[i] === "strategy_random" || keys[i] === "strategy_another") {
  ...
  render() {
    ...
    if (this.state.yourCreation.length === 2) {
      let cpt = 2;
      //delete for strategy_another
      if (this.state.strategy_anotherExpanded) {
      ...
      //delete for strategy_random
      if (this.state.strategy_randomExpanded) {
        for (
          let i = cpt;
    ...
    return (
      <>
        ...
        <SocketGetSynthesis
          ...
          strategy_random={this.state.clickedButtonStrix}
          strategy_another={this.state.clickedButtonParallel}
        ...
        <SynthesisForm
          ...
          strategy_anotherSynthesis={this.strategy_anotherSynthesis}
              ...
              <div className="w-full border-b-1">
                <div className="fs-4 m-2 text-center">
                  {this.state.clickedButtonStrix
                    ? synthesisInfo.info.buttons.synthesis.strategy_random
                    : synthesisInfo.info.buttons.synthesis.strategy_another}
                </div>
              </div>
