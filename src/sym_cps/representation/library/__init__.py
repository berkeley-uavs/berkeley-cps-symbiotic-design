...
class Library:
    ...
    def get_default_component(self, component_type: str, design_name: str = "", hub_size: int = 0) -> LibraryComponent:
        ...
        if design_name in default["SEED_DESIGNS"].keys():
            return self.components[default["SEED_DESIGNS"][design_name]["COMPONENTS"][component_type]]
        else:
            return self.components[default["ALL_COMPONENTS"][component_type][0]]
