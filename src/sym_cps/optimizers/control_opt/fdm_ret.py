...
class FDMResult:
    ...
    def readWarning(self, tokens):
        ...
        if(tokens[0] == "Caution:"):
            ...
            if len(tokens) >= 5 and tokens[1] == "at" and tokens[2] == "least" and tokens[3] == "one" and tokens[4] == "control":
                return 7
            # Caution: current exceeds contiuous maximum for at least one of the batteries.
            if len(tokens) >= 5 and tokens[1] == "current" and tokens[2] == "exceeds" and tokens[3] == "contiuous" and tokens[4] == "maximum":
                return 8
            return True
