...
def evaluate_design(
    ...
    if not info_only:
        ret = extract_results(result_path, control_opt=control_opt)
        return ret
...
if __name__ == "__main__":
    ...
    # design_json_path = "/Users/pier/Projects/challenge_data/output/designs/random_design_0/design_swri_missing_hub.json"
